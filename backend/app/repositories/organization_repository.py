...
from app.schemas.organization import OrganizationCreateInternal
...
class OrganizationRepository:
    ...
    def create(self, organization: OrganizationCreateInternal):
    ...
    # This is used by the slug service to check for slug uniqueness
